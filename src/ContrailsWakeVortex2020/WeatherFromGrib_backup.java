package ContrailsWakeVortex2020;//import de.tudresden.ifl.coala.tools.interpolate;
...
public class WeatherFromGrib_backup {


    public static void main(String[] args)
    {
        //WeatherFromGrib TEST = new WeatherFromGrib("/Users/marco/Desktop/testordner/A_HPXA89ECEM080000_C_ECMF_20200508000000_0h_em_msl_global_0p5deg_grib2.bin");
        //WeatherFromGrib TEST = new WeatherFromGrib("/Users/marco/Desktop/testordner/GRIBtest.grb");
        //WeatherFromGrib TEST = new WeatherFromGrib("/Users/marco/Downloads/icon-eu_europe_regular-lat-lon_single-level_2020051109_000_VMAX_10M.grib2");
        WeatherFromGrib_backup TEST = new WeatherFromGrib_backup("/Users/marco/Desktop/testordner/gribtesttest");
        //WeatherFromGrib TEST = new WeatherFromGrib("/Users/marco/Desktop/testordner/grib_01_2016-02-07_1200.grib2");
        //System.out.println(WeatherFromGrib.temperature("/Users/marco/Desktop/testordner/A_HPXA89ECEM080000_C_ECMF_20200508000000_0h_em_msl_global_0p5deg_grib2.bin"));
        System.out.println(TEST.mWind_v);
        //TEST.getIndex(50,100);
        System.out.println(TEST.getDLat());
        System.out.println(TEST.getLa1());
        System.out.println(TEST.getLo1());
        System.out.println(TEST.getIndex(5,10));
        System.out.println(TEST.getIndex(51,5));
        //System.out.println(TEST.getWindHeadingFromAltitude(50,10,10.0));
        System.out.println(TEST.getWindspeedFromAltitude(50,10,1000));
        System.out.println(TEST.getTempFromAltitude(50,10,2915)-273.15);
        System.out.println(TEST.getTempFromPressure(0,0,92500)-273.15);
        System.out.println(TEST.getWindHeadingFromPressure(0,0,20000));
        System.out.println(TEST.getWindspeedFromPressure(0,0,20000)*3.6/1.852);
        //System.out.println(TEST.getWindspeedFromAltitude(0,0,12500)*3.6/1.852);
        //System.out.println(TEST.getWindHeadingFromAltitude(0,0,760));
        System.out.println(TEST.getWindVFromAltitude(0,0,12500));
        System.out.println(TEST.getWindUFromAltitude(0,0,12500));

        //System.out.println(TEST.getAltitudeFromPressure(50,100,0));
    }

    //public final static Logger Log = LogManager.getLogger(WeatherFromGrib.class);
...
/*
    public static int WeatherFromGrib1(int zahl){
        zahl++;
        public final static int ZAHLXX = 2;
        return ZAHLXX;
    }
*/
    ...
    */
    ...
    public WeatherFromGrib_backup(TreeMap<Double, float[]> temperature,
    ...
    public WeatherFromGrib_backup(String gribFileName) {
     ...
     * For this, refer to {@link WeatherFromGrib_backup#getValueFromAltitude(double, double, double, TreeMap)}
     *
     * @param lat latitude [-90;90]
     * @param lon longitude [-180;180]
     ...
     * There is no interpolation between coordinates.
     * For this, refer to {@link WeatherFromGrib_backup#getValueFromPressure(double, double, double, TreeMap)}
     *
     * @param lat      latitude [-90;90]
     * @param lon      longitude [-180;180]
    ...
    public static class Timestamp {
        public final ZonedDateTime mIssued_dateTime;
        ...
        public Timestamp(ZonedDateTime issued_dateTime, int cycle, int forecast) {
