...
// **********************************************************
// This is the original wake_vortex file, here is the backup.
// **********************************************************

public class archive_wake_vortex
{
    ...
    public archive_wake_vortex(String ConfigFileName){
    ...
    public void ContrailEvolution()
    {
        ...
        do {
            ...
            t_old=t;
            t=t+delta_t;
            System.out.println("Lifetime t: "+t);
            ...
            //ALT: RHice=this.rsonde.get_RH(this.altitude+z)*eStar/eStarIce;
    ...
    public static void main(String[] args)
    {
        ...
        archive_wake_vortex wv= new archive_wake_vortex ("Config_NEU_03APR20.txt");
