...
import ContrailsWakeVortex2020TEST.Constants;
import ContrailsWakeVortex2020TEST.Wind;
import ContrailsWakeVortex2020TEST.interpolate;
...
public class WeatherFromGrib {
    ...
    public static void main(String[] args)
    {
        ...
        double testest = TEST.getTempFromAltitude(9,-2,10500);
